...
impl CommitCloudOpHeadsStore {
    ...
    // Currently unused, the function is implemented here to make the distinction between the 2 functions (this and get_op_heads_with_reconciliation), for future use
